...
static void engine_draw_frame(struct engine* engine) {
	...
	//float position1[] = { 0.0f, 0.0f, -3.0f };

	float position[] = { 0.0f, 1.0f, -6.0f };
	float position1[] = { 0.0f, -2.0f, -6.0f };

	cube1->rotateCubeEvent(cube1->getAngle_x(), cube1->getAngle_y());
	cube2->rotateCubeEvent(cube2->getAngle_x(), cube2->getAngle_y());
